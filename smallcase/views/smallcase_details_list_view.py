...
from smallcase.serializers import AnonymousUserSmallcaseDetailsSerializer
from smallcase.services import SmallcaseService


class SmallcaseDetailsListView(PublicBaseView):
    smallcase_service = SmallcaseService()
    serializer = AnonymousUserSmallcaseDetailsSerializer
    CACHE_KEY = "SMALLCASE_DETAILS_LIST"
    CACHE_TTL = 10_800
